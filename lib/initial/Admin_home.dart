...
import 'package:vishal/pages/Admin/Timetable.dart';
import 'package:vishal/services/reset_pw_page.dart';
import '../common pages/Leave application.dart';
import '../pages/Admin/new_notice.dart';
import '../pages/Students/page_attendance.dart';
...
class _Admin_homeState extends State<Admin_home> {
  ...
  Future passwordresetlink() async {
    try {
      await FirebaseAuth.instance
          .sendPasswordResetEmail(email: _passwordreset.text.trim());
  ...
  // funtion for firebase api connection
  ...
  Future<void> sendFCMMessage() async {
    ...
    final Map<String, dynamic> message = {
      'message': {
        ...
        'notification': {'body': 'this is vishal', 'title': 'FCM message'},
  ...
  void getdetail_email() async {
    var detailData = await Getdetails(username);
    var data = jsonDecode(detailData);
    name = data[0];
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _foldKey,
      drawer: Padding(
        padding: const EdgeInsets.only(right: 50.0, top: 100, bottom: 70),
        child: Drawer(
          width: 250,
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: IconButton(
                onPressed: () {
                  _foldKey.currentState!.openEndDrawer();
                },
                  ...
                  children: <Widget>[
                    CircleAvatar(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => const NewNotice(),));
                        },
                        iconSize: 30,
                        splashRadius: 30,
                      ),
                  ...
                  children: <Widget>[
                    CircleAvatar(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const Leave(),)),
                        iconSize: 30,
                        splashRadius: 30,
                      ),
                    ),
