...
class _NewHomeState extends State<NewHome> {
  ...
  //end for FCM code this way last line
    ...
    return Scaffold(
          ...
          child: Drawer(
            ...
            child: Center(
              child: MaterialButton(
                ...
                color: Colors.white,
                child: const Text("Login\n Now",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.black,),),
              ),
            )
          ),
        ),
      ...
      body: Container(
        ...
        child: ConstrainedBox(
          ...
          maxHeight: double.infinity, // Set the maximum height here
                                  ...
                                  Column(
                                      ...
                                      children: <Widget>[
                                        CircleAvatar(
                                          ...
                                          child: IconButton(
                                            onPressed: ()=>warning(
                                              const Text("No teachers data available. \n Login to use this feature")
                                            ),
                                            icon: Icon(
                                      ...
                                      children: <Widget>[
                                        CircleAvatar(
                                          ...
                                          child: IconButton(
                                            onPressed: ()=>warning(
                                              const Text(
                                                "Can't see use this option.\n For this please login first in our app",
                                ...
                                Column(
                                    ...
                                    children: <Widget>[
                                      CircleAvatar(
                                        ...
                                        child: IconButton(
                                          onPressed: ()=>warning(
                                              const Text("You have to not Logged in the app current\n So please login first"),
                                          ),
                                          icon: const Icon(
                    ...
                    child: Column(children: <Widget>[
                      ElevatedButton.icon(
                        ...
                        style: const ButtonStyle(
                          ...
                          fixedSize:
                          WidgetStatePropertyAll(Size.fromWidth(345.0)),
                        ),
  ...
  warning(Widget Context_warn) {
    showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
            content: Context_warn,
            actions: [
              ElevatedButton(
